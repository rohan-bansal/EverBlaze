...
public class FoodVendor extends NPC {

    Texture walkSheet;
    Texture idleSheet;
    Texture dieSheet;

    public FoodVendor(String name, int x, int y, MovementScript script) {
        super(name, Classifier.FoodVendor, x, y, 0.3f, script);

        walkSheet = new Texture(Gdx.files.internal("Entities/NPCFoodVendor/vendor_walk.png"));
        idleSheet = new Texture(Gdx.files.internal("Entities/NPCFoodVendor/vendor_idle.png"));
